...
└── vibe-coding-prompt.md # LLM development assistance document
```
...
### Page Structure
  ...
  * **Inventory Details:** Inventory query and statistics. The inventory history feature has been removed, and a refresh function has been added. Also includes a new estimated total cost display (based on `inventory quantity × latest inbound unit price`).
