...
export const inventoryService = {
   ...
   */
  async onInboundUpdate(oldRecord: Prisma.InboundRecordGetPayload<{}>, newRecord: Prisma.InboundRecordGetPayload<{}>) {
   ...
   */
  async onOutboundUpdate(oldRecord: Prisma.OutboundRecordGetPayload<{}>, newRecord: Prisma.OutboundRecordGetPayload<{}>) {
      // Revert Old, Apply New
