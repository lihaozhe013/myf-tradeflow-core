...
## `/api/payable/invoiced/:customer_code`
### GET
...
GET /api/payable/invoiced/:customer_code?page=1&limit=10
...
## `/api/payable/invoices/refresh/:customer_code`
### POST
...
POST /api/payable/invoices/refresh/:customer_code
