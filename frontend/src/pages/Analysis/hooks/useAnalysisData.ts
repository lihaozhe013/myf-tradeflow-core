...
export const useAnalysisData = () => {
  ...
  const fetchAnalysisData = useCallback(async (
    ...
    try {
      ...
      const result = await get(`/analysis/data?${params.toString()}`) as AnalysisApiResult<AnalysisData>;
      ...
      const detailResult = await get(`/analysis/detail?${params.toString()}`) as AnalysisApiResult<any>;
  ...
  const refreshAnalysisData = useCallback(async (
    ...
    try {
      ...
      const result = await post('/analysis/refresh', payload) as AnalysisApiResult<AnalysisData>;
